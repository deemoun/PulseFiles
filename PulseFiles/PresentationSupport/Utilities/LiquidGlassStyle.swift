...
enum LiquidGlassStyle {
    ...
    static var activeStroke: NSColor { NSColor.systemBlue.withAlphaComponent(isEnabled ? 0.58 : 0.7) }
    static var activeFill: NSColor { NSColor.systemBlue.withAlphaComponent(isEnabled ? 0.125 : 0.08) }
